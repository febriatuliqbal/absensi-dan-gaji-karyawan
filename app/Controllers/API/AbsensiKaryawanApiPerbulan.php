...
class AbsensiKaryawanApiPerbulan extends ResourceController
{
    /**
    ...
    public function show($cari = null)
    {
        ...
        $data = $modelInputAbsensi->join('tb_jamkerja', 'shift = id')->orLike('id_absensi', $cari)->orLike('id_absensi', $cari)->OrderBy('id_absensi', 'desc')->get()->getResult();
