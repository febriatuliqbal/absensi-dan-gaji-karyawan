...
class RiwayatLemburPerbulan extends ResourceController
{
    /**
    ...
    {
        $ModelDetailHutang = new ModelDetailLembur();
        $data = $ModelDetailHutang->orLike('id_lembur', $cari)->OrderBy('tgllembur', 'desc')->get()->getResult();
        $hutang = array_column($data, 'lama_lembur');
