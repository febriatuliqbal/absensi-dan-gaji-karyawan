...
class RiwayatGaji extends ResourceController
{
    /**
    ...
    public function show($cari = null)
    {
        ...
        $data = $ModelDetailHutang->tampildata()->where('idkar', $cari)->where('status_gaji', "Accept")->OrderBy('tgldetailgaji', 'desc')->get()->getResult();
