...
class DetailGajii extends ResourceController
{
    /**
    ...
    {
        $ModelDetailHutang = new ModelDetailGaji();
        $data = $ModelDetailHutang->tampildata()->where('id_detail_gaji', $cari)->where('status_gaji', "Accept")->OrderBy('tgldetailgaji', 'desc')->get()->getResult();
