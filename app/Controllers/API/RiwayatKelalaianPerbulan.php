...
class RiwayatKelalaianPerbulan extends ResourceController
{
    /**
    ...
    public function show($cari = null)
    {
        ...
        $data = $ModelDetailkelalaian->orLike('id_kelalaian', $cari)->OrderBy('tgl_kelalaian', 'desc')->get()->getResult();
        $kelalaian = array_column($data, 'jumlah_kelalain');
        $totalkelalaian = array_sum($kelalaian);
