...
class RekapInformasiDataKaryawan extends ResourceController
{
    /**
    ...
    public function show($cari = null)
    {
        ...
        $modelEstimasi = new ModelRekapInformasiKaryawan();
        $data = $modelEstimasi->tampildata()->orLike('id_rekap_informasi', $cari)->orLike('id_rekap_informasi', $cari)->get()->getResult();
