...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-8">
            ...
            <h1> <b>Input Data Absensi Izin Karyawan</b> </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Absensi</a></li>
                    <li class="breadcrumb-item active">Input Data Absensi Izin</li>
                </ol>
            </nav>
        </div>
...
<div class="card">
    <div class="card-body">
        ...
        <?= form_open_multipart('Absensi/simpandataizin') ?>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea placeholder="Jelaskan alasan izin" name="keterangan" class="form-control"
