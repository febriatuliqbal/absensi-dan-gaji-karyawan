...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-8">
            ...
            <h1> <b>Input Data Absensi Pulang Karyawan</b> </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Absensi</a></li>
                    <li class="breadcrumb-item active">Input Data Absensi Pulang</li>
                </ol>
            </nav>
        </div>
...
<div class="card">
    <div class="card-body">
        ...
        <?= form_open_multipart('Absensi/simpandatapulang') ?>
        ...
        <div class="row mb-3">
            <label for="inputNumber" class="col-sm-2 col-form-label">Jam Pulang</label>
            <div class="col-sm-10">
                <input id="jampulang" name="jampulang" type="time" class="form-control" required>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#formtambahabsensipulang').addClass('active');
