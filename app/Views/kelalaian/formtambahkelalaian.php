...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-8">
            ...
            <h1> <b>Input Data Kelalaian</b> </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Karyawan</a></li>
                    <li class="breadcrumb-item active">Input Data Kelalaian</li>
                </ol>
            </nav>
        </div>
...
<div class="card">
    <div class="card-body">
        ...
        <?= form_open_multipart('Kelalaian/simpandata') ?>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input id="kerugian" name="kerugian" type="number" class="form-control" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input id="potkelalaian" name="potkelalaian" type="number" class="form-control" readonly>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#inputdatakelalaian').addClass('active');
