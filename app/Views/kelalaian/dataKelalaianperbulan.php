...
<div class="pagetitle">
    ...
    <h1> <b>Daftar Kelalaian Perbulan </b> </h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Kelalaian</a></li>
            <li class="breadcrumb-item active">Daftar Kelalaian Perbulan</li>
        </ol>
    </nav>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <?= form_open('Kelalaian/dataperbulan') ?>
                    ...
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <b>
                            ...
                            <span class="badge bg-primary"> Rp.
                                <?= number_format($rew['subtotal_kelalaian'], 0) ?></span>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        foreach ($tampildatadetail as $row) :
                                            $totalhutang = $totalhutang + $row['jumlah_kelalain']
                                        ?>
...
$(document).ready(function() {
    ...
    $('#datakelalaianperbulan').addClass('active');
