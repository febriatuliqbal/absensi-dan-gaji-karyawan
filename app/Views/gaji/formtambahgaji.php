...
<div class="pagetitle">
    <div class="row">
        <div class="col-lg-8">
            ...
            <h1> <b>Rekap Data Gaji</b> </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Gaji</a></li>
                    <li class="breadcrumb-item active">Rekap Data Gaji</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="row mb-3" style="margin-top: -20px;">
            ...
            <div class="col-sm-3" style="margin-bottom: 10px;">
                <label for="inputText" class="col-sm-7 col-form-label">Jabatan Karyawan</label>
            ...
            <div class="col-sm-2" style="margin-bottom: 10px; ">
                ...
                <button type="button" style="width: 100%;" class="btn btn-m btn-primary" id="tombolcari"
                    name="tombolcari">
            ...
            <div class="col-sm-3">
                ...
                <button type="button" style="width: 100%;" class="btn btn-m btn-success" id="tombolrekap"
                    name="tombolrekap">
                    <i class="bi bi-plus-square-fill"> Masukan Kerekap</i>
            </div>
        ...
        <div class="row mb-3" style="margin-top: -20px;">
            <label for="inputText" class="col-sm-2 col-form-label">Total Gaji Bulan Ini :</label>
            <div class="col-sm-4" style="margin-bottom: 10px;">
...
function getdatadetail() {
    ...
    $.ajax({
        type: "post",
        url: "<?= base_url() ?>/Penggajian/datadetail",
        data: {
            id: idgaji
        },
        dataType: "json",
