...
<head>
    ...
    <title>MA. Advertising|Laporan Data Kelalaian Karyawan Perbulan</title>
        ...
        <section class="invoice">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <center> <b>
                            <address>
                                <h3><b>Laporan Data Kelalaian Karyawan <br> Perbulan </b>
                                    <small><br> Periode : <b> <?php if ($bulan == "01") : ?>
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: #e3f7ff;">
                                ...
                                <th colspan="2">
                                    ...
                                    Rp. <?= number_format($row['subtotal_kelalaian'], 0) ?>
                                </th>
                            ...
                            <tr>
                                ...
                                <?php if ($row['id_karyawan'] == $rew['idkaryawan_kelalain']) : ?>
                            ...
                            <tr class="table-sm">
                                ...
                                <td>
                                    ...
                                    Rp. <?= number_format($rew['jumlah_kelalain'], 0) ?>
                                </td>
                            ...
                            <?php endforeach; ?>
                            <tr>
                                <td colspan="3"><b>Total Semua Kelalian</b></td>
                                <td colspan="2">
