...
<head>
    ...
    <title>MA. Advertising|Laporan Data Gaji Karyawan Perbulan</title>
        ...
        <section class="invoice">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <center> <b>
                            <address>
                                <h3><b>Laporan Data Gaji Karyawan <br> Perbulan </b>
                    ...
                    <table class="table table-striped table-hover  table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Rp. <?= number_format($row['Hutang_informasi'], 0) ?>
                                </td>
                                <td>
                                    Rp. <?= number_format($row['gajiditerima'], 0) ?>
                                </td>
                            ...
                            <?php endforeach; ?>
                            <tr>
                                <td colspan="3"><b>Total Pengeluaran Gaji</b></td>
                                <td colspan="3">
