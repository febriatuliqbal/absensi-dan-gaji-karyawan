        ...
        <section class="invoice">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <center> <b>
                            <address>
                                <h3><b>Laporan Data Hutang Karyawan <br> Perbulan </b>
                        ...
                        <tbody>
                            ...
                            <tr style="background-color: #e3f7ff;">
                                ...
                                <th colspan="2">
                                    ...
                                    Rp. <?= number_format($row['subtotal_hutang'], 0) ?>
                                </th>
                            ...
                            <tr>
                                ...
                                <?php if ($row['id_karyawan_hutang'] == $rew['userkaryawan_hutang']) : ?>
                            ...
                            <tr class="table-sm">
                                ...
                                <td>
                                    ...
                                    Rp. <?= number_format($rew['jumlah_hutang'], 0) ?>
                                </td>
                            ...
                            <?php endforeach; ?>
                            <tr>
                                <td colspan="3"><b>Total Semua Hutang</b></td>
                                <td colspan="2">
