...
<div class="pagetitle">
    ...
    <h1> <b>Laporan Hutang Karyawan</b> </h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Laporan</a></li>
            <li class="breadcrumb-item active">Laporan Hutang Karyawan</li>
        </ol>
    </nav>
...
<div class="col-lg-12">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Laporan Hutang</h5>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            1-<strong>Laporan Hutang Perbulan Perkaryawan</strong>
                        </button>
                    </h2>
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                        ...
                        <div class="accordion-body">
                            ...
                            <?= form_open_multipart('Laporan/cetaklaporanhutangkaryawanperbulanperkaryawan', ['target' => '_blank']) ?>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            2-<strong>Rekap Hutang Perbulan</strong>
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                        ...
                        <div class="accordion-body">
                            ...
                            <!-- General Form Elements -->
                            <?= form_open_multipart('Laporan/cetaklaporanhutangkaryawanperbulan', ['target' => '_blank']) ?>
