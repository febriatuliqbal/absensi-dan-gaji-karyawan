...
<div class="pagetitle">
    ...
    <h1> <b>Laporan Lembur Karyawan</b> </h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Laporan</a></li>
            <li class="breadcrumb-item active">Laporan Lembur Karyawan</li>
        </ol>
    </nav>
                ...
                <div class="accordion-item ">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            ...
                            <strong>Laporan Lembur Karyawan Perbulan</strong>
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse show" aria-labelledby="headingThree"
                        ...
                        <div class="accordion-body">
                            ...
                            <?= form_open_multipart('Laporan/cetaklaporanlemburkaryawanperbulan', ['target' => '_blank']) ?>
...
$(document).ready(function() {
    ...
    $('#laporanlemburkaryawan').addClass('active');
