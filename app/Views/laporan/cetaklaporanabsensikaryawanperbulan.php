...
<head>
    ...
    <title>MA. Advertising|Laporan Data Absensi Karyawan Perbulan</title>
        ...
        <section class="invoice">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <center> <b>
                            <address>
                                <h3><b>Laporan Data Absensi Karyawan Perbulan</b></h3>
            ...
            <div class="row invoice-info">
                ...
                <div class="col-sm-3 invoice-col" style="margin-left: 20px;">
                    ...
                    <address>
                        Hadir : <b><?= $Hadir_rekap_informasi ?> x</b>
                        <br> Absen/Izin : <b><?= $Absen_rekap_informasi ?> x</b>
                        <br> Telat : <b><?= $Telat_rekap_informasi ?> x</b>
                        <br> Pulang Awal : <b><?= $Pulangcepat_rekap_informasi ?> x</b>
                    </address>
                </div>
