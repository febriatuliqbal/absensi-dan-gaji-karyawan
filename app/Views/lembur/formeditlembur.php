...
<div class="card">
    <div class="card-body">
        ...
        <?= form_open_multipart('Lembur/updatedata') ?>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10" style="margin-bottom: 10px;">
                ...
                <input id="idkelalaian" name="idkelalaian" value="<?= $id_lembur ?>" type="text" class="form-control"
                    hidden>
        ...
        <div class="row mb-3">
            <label for="inputNumber" class="col-sm-2 col-form-label">Lama Lembr(jam)</label>
            <div class="col-sm-10">
                <input id="lamalembur" name="lamalembur" value="<?= $lama_lembur ?>" type="number" class="form-control"
                    required>
                <input id="lamalemburawal" name="lamalemburawal" value="<?= $lama_lembur ?>" type="number"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea name="keterangan" class="form-control" style="height: 100px" required><?= $ket ?></textarea>
            </div>
        </div>
