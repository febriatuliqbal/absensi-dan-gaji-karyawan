...
<div class="pagetitle">
    ...
    <h1> <b>Daftar Lembur Perbulan </b> </h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Lembur</a></li>
            <li class="breadcrumb-item active">Daftar Lembur Perbulan</li>
        </ol>
    </nav>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        foreach ($tampildatadetail as $row) :
                                            $totalhutang = $totalhutang + $row['lama_lembur']
                                        ?>
...
$(document).ready(function() {
    ...
    $('#datalemburperbulan').addClass('active');
