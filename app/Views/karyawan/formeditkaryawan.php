...
<div class="card">
    <div class="card-body">
        ...
        <?= form_open_multipart('Karyawan/updatedata') ?>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input value="<?= $nama_karyawan ?>" name="nama" type="text" class="form-control" required>
            </div>
        </div>
        <div class="row mb-3">
            <label for="inputText" class="col-sm-2 col-form-label">Jabatan</label>
            <div class="col-sm-10">
                <input value="<?= $jabatan_karyawan ?>" name="jabatan" type="text" class="form-control" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <select name="status" class="form-select" aria-label="Default select example" required>
                    <option selected="<?= $status_karyawan ?>"><?= $status_karyawan ?></option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input value="<?= $gajipokok__karyawan ?>" name="gapok" type="number" class="form-control" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input value="<?= $tmakan_karyawan ?>" name="tmakan" type="number" class="form-control" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input value="<?= $thadir_karyawan ?>" name="thadir" type="number" class="form-control" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea name="alamat" class="form-control" style="height: 100px"
                    required><?= $alamat_karyawan ?></textarea>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <img style="max-height: 200px;" src="<?= base_url() ?>/uploud/<?= $foto_karyawan ?>" alt="Profile"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-7" style="margin-bottom: 10px;">
                <input value="<?= $username_karyawan ?>" id="username" name="username" type="text" class="form-control"
                    required>
