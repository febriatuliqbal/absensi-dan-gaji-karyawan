...
<!-- Modal -->
<div class="modal fade" id="modaldatakaryawan" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <script>
    function pilih(id, nama, jabatan) {
    ...
    function lisData() {
        var table = $('#dataPengguna').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url() ?>/Karyawan/listDataKaryawan",
                "type": "POST",
            },
            "columnDefs": [{
                "targets": [0, 3],
